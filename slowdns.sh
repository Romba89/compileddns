...
cd
#wget -q -O /etc/systemd/system/client-sldns.service "https://raw.githubusercontent.com/Romba89/compileddns/main/client-sldns.service"
#wget -q -O /etc/systemd/system/server-sldns.service "https://raw.githubusercontent.com/Romba89/compileddns/main/server-sldns.service"
